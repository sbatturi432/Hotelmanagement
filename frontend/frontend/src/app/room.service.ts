...
export class RoomService {
  ...
  adminRoomList() {
    return this.http.get<any>('http://localhost:10000/getRoomList');

  }

  deleteRoomInfo(data) {
    console.log(data);
    return this.http.delete(`http://localhost:10000/deleteRoom/${data.roomId}`);
  }

  updateRoomInfo(data) {
    console.log(data);
    return this.http.put('http://localhost:10000/updateRoomInforamtion', data);
  }

  addRoom(data): Observable<any> {
    console.log(data);
    return this.http.put<any>('http://localhost:10000/addRoomInformation', data);
  }
