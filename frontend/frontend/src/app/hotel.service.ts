...
export class HotelService {
  ...
  adminHotelList() {
    return this.http.get<any>('http://localhost:10000/getHotelList');

  }

  deleteHotelInfo(data) {
    console.log(data);
    return this.http.delete(`http://localhost:10000/deleteHotel/${data.hotelId}`);
  }

  updateHotelInfo(data) {
    console.log(data);
    return this.http.put('http://localhost:10000/updateHotelInformation', data);
  }


  addHotel(data): Observable<any> {
    console.log(data);
    return this.http.post<any>('http://localhost:10000/addHotel', data);
  }

  singleHotelData(data) {
    console.log(data);
    this.http.post<any>('http://localhost:10000/getRoomListForUser', data).subscribe((response) => {
  ...
  addUserBooking(data): Observable<any> {
    console.log(data);
    return this.http.put<any>('http://localhost:10000/userRoomBooking', data);
  }

  calculateTotalDays(data) {
    console.log(data);
    this.http.post<any>('http://localhost:10000/calculateTotalDaysAmount', data).subscribe((response) => {
  ...
  adminBookingReport() {
    console.log('.................');
    return this.http.get<any>('http://localhost:10000/getBookingHistoryForAdmin');
  ...
  userBookingReport(userData) {
    ...
    return this.http.post<any>('http://localhost:10000/getBookingHistoryForUser', userData);
  ...
  deleteRoomBooking(data) {
    console.log(data);
    return this.http.delete(`http://localhost:10000/cancelBooking/${data.bookingId}`);
  }
}
